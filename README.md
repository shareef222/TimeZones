...
[MIT](LICENSE), free to use, modify, and distribute. `Cities.tsv` is derived from GeoNames data, licensed [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/); attribution: geonames.org.
